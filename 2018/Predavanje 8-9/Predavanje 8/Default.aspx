...
<body>
    <form id="form1" runat="server">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
        &nbsp;&nbsp;&nbsp;&nbsp; 
        <asp:TextBox ID="tb_lime" runat="server"></asp:TextBox>
        <br />
        Lozinka:&nbsp;&nbsp;&nbsp;&nbsp; 
        <asp:TextBox ID="tb_llozinka" runat="server" TextMode="Password"></asp:TextBox>
        <br />
        <br />
        <asp:Button ID="Button2" runat="server" Text="Spremi" OnClick="Button2_Click"  />
            <hr />
            <br />
