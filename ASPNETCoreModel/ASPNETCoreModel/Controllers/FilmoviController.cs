...
namespace ASPNETCoreModel.Controllers
{
    public class FilmoviController : Controller
    {
        ...
        public FilmoviController(BazaKontekst context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Naziv,Komentar,DatIzd")] Film film)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Naziv,Komentar,DatIzd")] Film film)
        {
            if (id != film.Id)
            {
                return NotFound();
