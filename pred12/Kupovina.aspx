...
<body>
    ...
    <h4> Kupljeni artikli </h4>
        <asp:GridView ID="gv_kupovina" runat="server" AutoGenerateColumns="False" 
            onrowcommand="gv_kupovina_RowCommand" 
            onrowdeleting="gv_kupovina_RowDeleting" 
            onrowediting="gv_kupovina_RowEditing" 
            onrowcancelingedit="gv_kupovina_RowCancelingEdit" onrowupdating="gv_kupovina_RowUpdating" 
            >
            <Columns>
                <asp:BoundField DataField="Id" HeaderText="Broj" ReadOnly="True" />
                <asp:BoundField DataField="Naziv" HeaderText="Naziv" ReadOnly="True" />
                <asp:BoundField DataField="Cijena" DataFormatString="{0:C}" 
                    HeaderText="Cijena" ReadOnly="True" />
                <asp:BoundField DataField="Kolicina" HeaderText="Količina" />
                <asp:BoundField DataField="Ukupno" DataFormatString="{0:C}" 
                    HeaderText="Ukupno" ReadOnly="True" />
                <asp:ButtonField CommandName="Dodaj" Text="Povecaj +1" />
                <asp:CommandField DeleteText="Brisi" ShowDeleteButton="True" />
                <asp:CommandField CancelText="Odustani" EditText="Promijeni" 
